...
pop <- melt(pop, id.vars = c("Code"), variable.name = "Year", variable.vale = "pop")
gdp <- melt(gdp, id.vars = c("Code"), variable.name = "Year", variable.vale = "gdp")
pop<-pop %>%
...
tot_energy_wide  <- tot_energy_wide[,c('Year',  'State',
  'Population',
  'GDP',
  'Coal',
  'Petroleum',
